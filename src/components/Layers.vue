<template lang="">
    ...
    <div id="layersList">
        ...
        <div class="baseMapList">
            <ul>
                <li>
                    <a href="javascript:void(0);" @click="selectedLayer='Vec' "><img :style="selectedFlag.Vec" src="../assets/vec.jpg" alt="矢量图"><h2>地图</h2></a>
                </li>
                <li>
                    <a href="javascript:void(0);" @click="selectedLayer='Img'"><img :style="selectedFlag.Img" src="../assets/img.jpg" alt="影像图"><h2>影像</h2></a>
                </li>
                <li>
                    <a href="javascript:void(0);" @click="selectedLayer='Ter'"><img :style="selectedFlag.Ter" src="../assets/ter.jpg" alt="地形图"><h2>地形</h2></a>
                </li>
            </ul>
        </div>
